class RatingsController < ApplicationController
  ...
  # before_filter :login_required   # this is specific to acts_as_authenticated plugin
  ...
  def rate
    ...
    Rating.delete_all(["rateable_type = ? AND rateable_id = ? AND user_id = ?", @rateable_class.base_class.to_s, params[:id], session[:user].id])  
